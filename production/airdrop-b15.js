...
async function main() {
    ...
    let activesData = await readCsvFile('mythos-airdrop-b15.csv');
    ...
    const inactiveAmount = '12000000000000000000'; // 12 MYTH
    var transfersData = [];
    ...
    const additionalTransferAmount = '236';
    ...
    for (let i = 0, batch = 0; i < transfersData.length; i += MAX_CALLS_PER_BATCH, batch++) {
		...
		console.log(`${airdrop_amount}${decimalString}`);
